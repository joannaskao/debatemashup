...
function preloadData() {
  ...
  var bufferLoader = new BufferLoader(
    audio_context,
    [
      "/static/samples/what it takes.wav",
      "/static/samples/binders full of women.wav",
      "/static/samples/but gosh.wav",
      "/static/samples/romney jobs1.wav",
      "/static/samples/you\'ll get your chance.wav",
      "/static/samples/big bird.wav",
      "/static/samples/push on this issue.wav",
      "/static/samples/not as big as yours.wav",
      "/static/samples/gang bangers.wav",
      "/static/samples/i don\'t look at my pension.wav",
      "/static/samples/electro_hop.mp3"
    ], 
    function(list) {
      // console.log("loaded");
